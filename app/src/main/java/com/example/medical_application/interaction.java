...
public class interaction extends AppCompatActivity {
    ...
    private String URL = ipforall.ipt+"interaction.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bt3 = findViewById(R.id.button1);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || mdate.isEmpty() || feel.isEmpty() ||cmt.isEmpty()){
                    Toast.makeText(interaction.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void sendLoginRequest(final String username) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                System.out.println(username+mdate+feel+cmt);
