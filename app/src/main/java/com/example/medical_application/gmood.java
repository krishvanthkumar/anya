...
public class gmood extends AppCompatActivity {
    Button btn;
    private String username,mdate;
    LocalDate currentDate;
    private String mood = "";

    private String URL = ipforall.ipt+"gmood.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gmood);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || mdate.isEmpty() || mood.isEmpty() ){
                    Toast.makeText(gmood.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(gmood.this, guardian_home.class);
